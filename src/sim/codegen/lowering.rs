...
impl<'a> Codegen<'a> {
    ...
    fn ensure_assertion_local_initializer(
        &mut self,
        path: &str,
        target: NodeId,
    ...
    fn assertion_local_lhs_target(&self, lhs: NodeId) -> Option<NodeId> {
        match self.kind(lhs) {
