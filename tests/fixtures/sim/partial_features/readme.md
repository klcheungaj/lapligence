...
| `assertions*.sv` | Immediate assert/assume/cover four-state truth, one-time condition evaluation, action defaults, labels and optimizer-preserved cover callbacks |
