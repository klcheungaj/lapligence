...
fn mailbox_equivalent() {
    sim_cli::run_case(
        "review_batch4",
        "mailbox_equivalent",
        "mailbox equivalence and ref destination ok\n",
        "",
        &[],
    );
}
...
fn repetition_guards() {
    sim_cli::run_case(
        "review_batch4",
        "repetition_guards",
        "guarded repetition endpoints ok\n",
        "",
        &[],
    );
}
...
fn implication_branches() {
    sim_cli::run_case(
        "review_batch4",
        "implication_branches",
        "implication branching endpoints ok\n",
        "",
        &[],
    );
}
...
fn packed_array_prefixes() {
    sim_cli::run_case(
        "review_batch4",
        "packed_array_prefixes",
        "packed array prefixes ok\n",
        "",
